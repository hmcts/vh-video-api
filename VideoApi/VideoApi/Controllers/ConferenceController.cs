...
namespace VideoApi.Controllers
{
        ...
        : ControllerBase
    {
        ...
        [ProducesResponseType((int)HttpStatusCode.NotFound)]
        [ProducesResponseType(typeof(ValidationProblemDetails), (int)HttpStatusCode.BadRequest)]
        public async Task<IActionResult> GetConferenceByHearingRefIdAsync([FromQuery] Guid[] hearingRefIds,
            [FromQuery] bool? includeClosed = false)
        {
            var query = new GetNonClosedConferenceByHearingRefIdQuery(hearingRefIds, includeClosed.GetValueOrDefault());
