...
namespace VideoApi.Client
{
    ...
    public partial interface IVideoApiClient
    {
        ...
        /// <exception cref="VideoApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RoomResponse> GetActiveJohConsultationRoomAsync(string conferenceId);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="VideoApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<RoomResponse> GetActiveJohConsultationRoomAsync(string conferenceId, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class VideoApiClient : IVideoApiClient
    {
        ...
        /// <exception cref="VideoApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<RoomResponse> GetActiveJohConsultationRoomAsync(string conferenceId)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="VideoApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<RoomResponse> GetActiveJohConsultationRoomAsync(string conferenceId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/consultations?");
            if (conferenceId != null)
