...
namespace VideoApi.Services
{
    ...
    public class KinlyPlatformServiceStub : IVideoPlatformService
    {
        ...
        {
            var adminUri = "https://ext-node02.com/webapp/#/?conference=user@hmcts.net";
            var judgeUri = "https://ext-node02.com/webapp/#/?conference=user@hmcts.net";
            var participantUri = "https://ext-node02.com/webapp/#/?conference=user@hmcts.net";
