...
namespace VideoApi.Services.Kinly
{
    ...
    public partial interface IKinlyApiClient
    {
        ...
        /// <exception cref="KinlyApiException">A server side error occurred.</exception>
        Task StartAsync(string hearingId, StartHearingRequest startHearingRequest);
    ...
    public partial class KinlyApiClient : IKinlyApiClient
    {
        ...
        /// <returns>Tries to start Hearing</returns>
        /// <exception cref="KinlyApiException">A server side error occurred.</exception>
        public Task StartAsync(string hearingId, StartHearingRequest startHearingRequest)
        {
    ...
    public partial class StartHearingRequest 
    {
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<StartHearingRequest>(data);
        }
