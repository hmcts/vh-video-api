...
namespace VideoApi.Services.Kinly
{
    ...
    public partial class KinlyApiClient : IKinlyApiClient
    {
        ...
        /// <returns>Tries to start Hearing</returns>
        /// <exception cref="KinlyApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task StartAsync(string hearingId, StartHearingRequest startHearingRequest)
        {
        ...
        /// <returns>Tries to start Hearing</returns>
        /// <exception cref="KinlyApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task StartAsync(string hearingId, StartHearingRequest startHearingRequest, System.Threading.CancellationToken cancellationToken)
        {
            if (hearingId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    var content_ = new System.Net.Http.StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(startHearingRequest, _settings.Value));
                    content_.Headers.ContentType = System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
