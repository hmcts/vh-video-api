...
namespace VideoApi.DAL.Migrations
{
    ...
    [Migration("20250320130733_AddedOneToManyRelationshipToEndpointParticipant")]
    partial class AddedOneToManyRelationshipToEndpointParticipant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoApi.Domain.Conference", b =>
                {
                    ...
                    b.Property<int>("AudioPlaybackLanguage")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
                    ...
                    b.Property<int>("ConferenceRoomType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VideoApi.Domain.ParticipantBase", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ParticipantBase");
            ...
            modelBuilder.Entity("VideoApi.Domain.ParticipantBase", b =>
                {
                    ...
                    b.HasOne("VideoApi.Domain.Endpoint", "Endpoint")
                        .WithMany("ParticipantsLinked")
            ...
            modelBuilder.Entity("VideoApi.Domain.Endpoint", b =>
                {
                    b.Navigation("ParticipantsLinked");
                });
