...
namespace VideoApi.IntegrationTests.Steps
{
    ...
    public sealed class ParticipantSteps : BaseSteps
    {
        ...
        public async Task GivenIHaveHeartbeats()
        {
            ...
            var heartbeats = new List<Heartbeat>
            {
                new Heartbeat(_context.Test.Conference.Id, participantId,
                    1, 2, 3, 4, 5, 6, 7, 8, DateTime.UtcNow.AddMinutes(5), "chrome", "1", "Mac OS X", "10.15.7",0,"25kbps","opus",1,1,0,25,"2kbps","H264","640x480","18kbps","opus",1,0,"106kbps","VP8","1280x720",1,0,device:"iPhone" ),
                new Heartbeat(_context.Test.Conference.Id, participantId,
                    8, 7, 6, 5, 4, 3, 2, 1, DateTime.UtcNow.AddMinutes(2), "chrome", "1", "Mac OS X", "10.15.7",0,"25kbps","opus",1,1,0,25,"2kbps","H264","640x480","18kbps","opus",1,0,"106kbps","VP8","1280x720",1,0,device:"iPhone" ),
                new Heartbeat(_context.Test.Conference.Id, participantId,
        ...
        public async Task GivenIHaveHeartbeatsToRemove()
        {
            ...
            {
                new Heartbeat(_context.Test.Conference.Id, participantId,
                    1, 2, 3, 4, 5, 6, 7, 8, DateTime.UtcNow.AddDays(-14), "chrome", "1", "Mac OS X", "10.15.7",0,"25kbps","opus",1,1,0,25,"2kbps","H264","640x480","18kbps","opus",1,0,"106kbps","VP8","1280x720",1,0 ,device:"iPhone"),
                new Heartbeat(_context.Test.Conference.Id, participantId,
                    8, 7, 6, 5, 4, 3, 2, 1, DateTime.UtcNow.AddDays(-14), "chrome", "1", "Mac OS X", "10.15.7",0,"25kbps","opus",1,1,0,25,"2kbps","H264","640x480","18kbps","opus",1,0,"106kbps","VP8","1280x720",1,0 ,device:"iPhone"),
                new Heartbeat(_context.Test.Conference.Id, participantId,
