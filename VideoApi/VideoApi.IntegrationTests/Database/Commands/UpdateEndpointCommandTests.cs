...
public class UpdateEndpointCommandTests : DatabaseTestsBase
{
    ...
    public void Should_throw_conference_not_found_exception_when_conference_does_not_exist()
    {
        ...
        var command = new UpdateEndpointCommand(conferenceId, "sip@sip.com", displayName, ConferenceRole.Host);
    ...
    public async Task Should_throw_exception_when_endpoint_does_not_exist()
    {
        ...
        var command = new UpdateEndpointCommand(_newConferenceId, "sip@sip.com", displayName, ConferenceRole.Host);
    ...
    public async Task Should_update_existing_endpoint_with_new_display_name()
    {
        ...
        var command = new UpdateEndpointCommand(_newConferenceId, sipAddress, newDisplayName, newConferenceRole);
