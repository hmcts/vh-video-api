...
namespace VideoApi.UnitTests.Domain
{
    public class RoomTest
    {
        ...
        public void Should_add_participant_to_room()
        {
            ...
            var roomParticipant = new RoomParticipant(1, participantId, DateTime.UtcNow);
        ...
        public void Should_throw_exception_for_remove_non_existing_participant_from_room()
        {
           ...
           Action action = () => room.RemoveParticipant(new RoomParticipant(1, Guid.NewGuid(), DateTime.UtcNow));
