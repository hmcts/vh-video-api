...
namespace VideoApi.UnitTests.Services
{
    ...
    public class AudioPlatformServiceTest
    {
        ...
        {
            _wowzaClient
                .Setup(x => x.GetApplicationAsync(It.IsAny<string>()))
        ...
        {
            _wowzaClient
                .Setup(x => x.CreateApplicationAsync(It.IsAny<string>(), It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        {
            _wowzaClient
                .Setup(x => x.UpdateApplicationAsync(It.IsAny<string>(), It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        public async Task CreateAudioApplicationWithStreamAsync_Returns_True_AudioPlatformServiceResponse_With_IngestUrl()
        {
            ...
            _wowzaClient
              .Setup(x => x.UpdateApplicationAsync(It.IsAny<string>(), It.IsAny<string>()));
            _wowzaClient
                .Setup(x => x.AddStreamRecorderAsync(It.IsAny<string>()));
        ...
        {
            _wowzaClient
                .Setup(x => x.DeleteApplicationAsync(It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        {
            _wowzaClient
                .Setup(x => x.MonitoringStreamRecorderAsync(It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        {
            _wowzaClient
                .Setup(x => x.GetStreamRecorderAsync(It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        {
            _wowzaClient
                .Setup(x => x.StopStreamRecorderAsync(It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
