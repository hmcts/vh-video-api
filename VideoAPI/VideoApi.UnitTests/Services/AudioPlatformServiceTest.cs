...
namespace VideoApi.UnitTests.Services
{
    ...
    public class AudioPlatformServiceTest
    {
        ...
        [Test]
        public async Task CreateAudioApplicationWithStreamAsync_Returns_False_On_Both_Nodes_Erroring_AudioPlatformServiceResponse_When_AudioPlatformException_Thrown_With_DefaultIngestUrl()
        {
            _wowzaClient1
                .Setup(x => x.CreateApplicationAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
        ...
        [Test]
        public async Task CreateAudioApplicationWithStreamAsync_Returns_Even_When_One_Node_Success_False_AudioPlatformServiceResponse_When_AudioPlatformException_Thrown_With_DefaultIngestUrl()
        {
            _wowzaClient1
                .Setup(x => x.CreateApplicationAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(Task.CompletedTask);
        ...
        [Test]
        public async Task CreateAudioApplicationWithStreamAsync_Returns_False_Even_When_One_Node_Success_AudioPlatformServiceResponse_When_AudioPlatformException_Thrown_On_Update_With_DefaultIngestUrl()
        {
            _wowzaClient1
                .Setup(x => x.UpdateApplicationAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .Returns(Task.CompletedTask);
        ...
        [Test]
        public async Task CreateAudioApplicationWithStreamAsync_Returns_False_When_One_Node_Errors_AudioPlatformServiceResponse_With_IngestUrl()
        {
            _wowzaClient1
                .Setup(x => x.CreateApplicationAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()));
            _wowzaClient1
        ...
        [Test]
        public async Task CreateAudioStreamAsync_Returns_False_Even_When_One_Node_Success_AudioPlatformServiceResponse_When_AudioPlatformException_Thrown_With_Default_IngestUrl()
        {
            _wowzaClient1
                .Setup(x => x.AddStreamRecorderAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .ThrowsAsync(new AudioPlatformException("SomeError", HttpStatusCode.InternalServerError));
